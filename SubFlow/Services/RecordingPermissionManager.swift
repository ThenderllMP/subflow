...
enum RecordingPermissionError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .screenRecordingDenied:
            return "Screen recording permission is still not active. Open System Settings > Privacy & Security > Screen Recording, enable CapiX, then quit and reopen the app."
        }
    }
